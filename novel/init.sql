...
alter table book_comment add column `support_count` int(11) DEFAULT '0' COMMENT '支持数量';
alter table book_comment add column `opposition_count` int(11) DEFAULT '0' COMMENT '反对数量';